...
- _InitSigning_, naudojamas **inicijuoti** dokumento **pasirašymą**;
- _SigningResult_, naudojamas **pasirašymo būsenai sužinoti** (jei pasirašymo transakcija yra pasibaigusi sėkmingai, gražinamas pasirašytas dokumentas ir informaciją apie pasirašiusį asmenį);
- _SigningCancel_, naudojamas pasirašymo **transakcijai nutraukti**;
- _Seal_, naudojamas RC spaudui dėti ant PDF dokumentų (tik Registrų Centro sistemoms);
...
## InitAdoc metode naudojami kiti struktūriniai tipai
